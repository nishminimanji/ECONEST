...
<div id="popup-message" class="fixed top-0 right-0 flex items-center justify-center z-50 bg-black bg-opacity-30 hidden">
  ...
  <body class="bg-gray-100">
    <div class="container mx-auto px-4 py-8">
        <h1 class="text-3xl font-bold text-center mb-8">Sofa Sets</h1>
        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
            <!-- Product Card -->
            <div class="bg-white shadow-lg rounded-lg overflow-hidden hover:scale-105 transition-transform">
                <div class="w-full h-48">
                    <img src="https://damro.lk/wp-content/uploads/2023/01/DAHAMRO-EAL3-EAM2-WEB-1-1-1.jpg" alt="sofa 1" class="w-100 h-100 object-cover">
                </div>
                <div class="p-4">
                    <p class="text-lg font-semibold">Dahamro Sofa 3 Seater | 1 Seater | 1 Seater<p>
                    <p class="text-xl text-red-600 mt-2">Rs. 82,300</p>
            ...
            <div class="bg-white shadow-lg rounded-lg overflow-hidden hover:scale-105 transition-transform">
                <div class="w-full h-45">
                    <img src="https://damro.lk/wp-content/uploads/2020/01/leena-sofa-2-1.jpg" alt="sofa 2" class="w-100 h-100 object-cover">
                </div>
                <div class="p-4">
                    <p class="text-lg font-semibold">Sentinal Sofa 3 Seater | 1 Seater | 1 Seater</p>
                    <p class="text-xl text-red-600 mt-2">Rs. 175,750</p>
                    <div class="mt-4 flex justify-center">
                    <button class="bg-red-500 text-white px-6 py-2 rounded-full hover:bg-red-400 add-to-cart text-center">Add to Cart</button></div>
            ...
            <div class="bg-white shadow-lg rounded-lg overflow-hidden hover:scale-105 transition-transform">
                <div class="w-full h-45">
                    <img src="https://damro.lk/wp-content/uploads/2024/01/Lexington-New-Web.jpg" alt="sofa 3" class="w-100 h-100 object-cover">
                </div>
                <div class="p-4">
                    <p class="text-lg font-semibold">Lexington sofa 3 Seater | 2 Seater | 1 Seater </p>
                    <p class="text-xl text-red-600 mt-2">Rs. 240,115</p>
                    <div class="mt-4 flex justify-center">
                    <button class="bg-red-500 text-white px-6 py-2 rounded-full hover:bg-red-400 add-to-cart text-center">Add to Cart</button></div>
             ...
             <div class="bg-white shadow-lg rounded-lg overflow-hidden hover:scale-105 transition-transform">
                <div class="w-full h-45">
                    <img src="https://damro.lk/wp-content/uploads/2020/01/Clansy-02-1.jpg" alt="sofa 4" class="w-100 h-100 object-cover">
                </div>
                <div class="p-4">
                    <p class="text-lg font-semibold">Clancy Sofa 3 Seater | 1 Seater | 1 Seater</p>
                    <p class="text-xl text-red-600 mt-2">Rs.324,200</p>
                    <div class="mt-4 flex justify-center">
                    <button class="bg-red-500 text-white px-6 py-2 rounded-full hover:bg-red-400 add-to-cart text-center">Add to Cart</button></div>
            ...
            <div class="bg-white shadow-lg rounded-lg overflow-hidden hover:scale-105 transition-transform">
                <div class="w-full h-45">
                    <img src="https://singerwebcdn.azureedge.net/resources/products/normal/WF-MILAN-DSBR-S-01.webp" alt="sofa 5" class="w-100 h-100 object-cover">
                </div>
                <div class="p-4">
                    <p class="text-lg font-semibold">Milan Sofa - Fabric Design Brown</p>
                    <p class="text-xl text-red-600 mt-2">Rs. 69,599</p>
                    <div class="mt-4 flex justify-center">
                    <button class="bg-red-500 text-white px-6 py-2 rounded-full hover:bg-red-400 add-to-cart text-center">Add to Cart</button></div>
            ...
            <div class="bg-white shadow-lg rounded-lg overflow-hidden hover:scale-105 transition-transform">
                <div class="w-full h-45">
                    <img src="https://singerwebcdn.azureedge.net/resources/products/normal/WF-DISNEY-311-BG-S-01.webp" alt="sofa 6" class="w-100 h-100 object-cover">
                </div>
                <div class="p-4">
                    <p class="text-lg font-semibold">Disney Sofa - Beige Colour Design</p>
                    <p class="text-xl text-red-600 mt-2">Rs.151,950</p>
                    <div class="mt-4 flex justify-center">
                    <button class="bg-red-500 text-white px-6 py-2 rounded-full hover:bg-red-400 add-to-cart text-center">Add to Cart</button></div>
            ...
            <div class="bg-white shadow-lg rounded-lg overflow-hidden hover:scale-105 transition-transform">
                <div class="w-full h-45">
                    <img src="https://singerwebcdn.azureedge.net/resources/products/normal/WF-BALTIC-01-S-01-20240830.webp" alt="sofa 7" class="w-100 h-100 object-cover">
                </div>
                <div class="p-4">
                    <p class="text-lg font-semibold">Baltic Sofa - Blue Colour Fabric Design</p>
                    <p class="text-xl text-red-600 mt-2">Rs.269,600</p>
                    <div class="mt-4 flex justify-center">
                    <button class="bg-red-500 text-white px-6 py-2 rounded-full hover:bg-red-400 add-to-cart text-center">Add to Cart</button></div>
              ...
              <div class="bg-white shadow-lg rounded-lg overflow-hidden hover:scale-105 transition-transform">
                <div class="w-full h-45">
                    <img src="https://singerwebcdn.azureedge.net/resources/products/normal/WF-QUEEN-311-BR-S-01.webp" alt="sofa 8" class="w-100 h-100 object-cover">
                </div>
                <div class="p-4">
                    <p class="text-lg font-semibold">Queen Sofa  - Brown colour Design </p>
                    <p class="text-xl text-red-600 mt-2">Rs.139,950</p>
                    <div class="mt-4 flex justify-center">
                    <button class="bg-red-500 text-white px-6 py-2 rounded-full hover:bg-red-400 add-to-cart text-center">Add to Cart</button></div>
            ...
            <div class="bg-white shadow-lg rounded-lg overflow-hidden hover:scale-105 transition-transform">
                <div class="w-full h-48">
                    <img src="https://damro.lk/wp-content/uploads/2021/07/Britoli-nerw-1.jpg" alt="sofa 9" class="w-100 h-100 object-cover">
                </div>
                <div class="p-4">
                <p class="text-lg font-semibold">Britoli Sofa 3 Seater</p>
                    <p class="text-xl text-red-600 mt-2">Rs.107,100</p>
                    <div class="mt-4 flex justify-center">
                    <button class="bg-red-500 text-white px-6 py-2 rounded-full hover:bg-red-400 add-to-cart text-center">Add to Cart</button></div>
            ...
            <div class="bg-white shadow-lg rounded-lg overflow-hidden hover:scale-105 transition-transform">
                <div class="w-full h-48">
                    <img src="https://damro.lk/wp-content/uploads/2021/08/oxford-1-548x343-1.jpg" alt="sofa 10" class="w-100 h-100 object-cover">
                </div>
                <div class="p-4">
                    <p class="text-lg font-semibold">Oxford Sofa 3 Seater</p>
                    <p class="text-xl text-red-600 mt-2">Rs.144,490</p>
                    <div class="mt-4 flex justify-center">
                    <button class="bg-red-500 text-white px-6 py-2 rounded-full hover:bg-red-400 add-to-cart text-center">Add to Cart</button></div>
             ...
             <div class="bg-white shadow-lg rounded-lg overflow-hidden hover:scale-105 transition-transform">
                <div class="w-full h-48">
                    <img src="https://damro.lk/wp-content/uploads/2021/08/vegas-1-1.jpg" alt="sofa 11" class="w-100 h-100 object-cover">
                </div>
                <div class="p-4">
                    <p class="text-lg font-semibold">Vegas Sofa 3 Seater</p>
                    <p class="text-xl text-red-600 mt-2">Rs.237,999</p>
                    <div class="mt-4 flex justify-center">
                    <button class="bg-red-500 text-white px-6 py-2 rounded-full hover:bg-red-400 add-to-cart text-center">Add to Cart</button></div>
             ...
             <div class="bg-white shadow-lg rounded-lg overflow-hidden hover:scale-105 transition-transform">
                <div class="w-full h-48">
                    <img src="https://damro.lk/wp-content/uploads/2021/08/boxberg-1-1.jpg" alt="sofa 12" class="w-100 h-100 object-cover">
                </div>
                <div class="p-4">
                    <p class="text-lg font-semibold">Boxberg Sofa 3 Seater</p>
                    <p class="text-xl text-red-600 mt-2">Rs.204,520</p>
                    <div class="mt-4 flex justify-center">
                    <button class="bg-red-500 text-white px-6 py-2 rounded-full hover:bg-red-400 add-to-cart text-center">Add to Cart</button></div>
