...
<div id="popup-message" class="fixed top-0 right-0 flex items-center justify-center z-50 bg-black bg-opacity-30 hidden">
  ...
  <body class="bg-gray-100">
    <div class="container mx-auto px-4 py-8">
        <h1 class="text-3xl font-bold text-center mb-8">Blenders & Mixers</h1>
        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
            ...
            <div class="bg-white shadow-lg rounded-lg overflow-hidden hover:scale-105 transition-transform">
                ...
                <div class="p-4">
                    <p class="text-lg font-semibold">Panasonic Super Mixer Grinders</p>
             ...
             <div class="bg-white shadow-lg rounded-lg overflow-hidden hover:scale-105 transition-transform">
                ...
                <div class="p-4">
                    <p class="text-lg font-semibold">Panasonic 4 Jar Mixer Grinders</p>
