...
<section class="relative bg-cover bg-center py-20" style="background-image: url('https://blog.bestbuy.ca/wp-content/uploads/2019/03/smart-appliances-to-add-to-your-smart-home-747x420.jpg'); background-size: cover; background-position: center; min-height: 400px;">
...
<section class="bg-gray-50 py-10">
  <div class="container mx-auto text-center">
    <h3 class="text-2xl font-semibold text-green-700 mb-4">Contact Information</h3>
    <p class="text-lg text-gray-700">We would love to hear from you! If you have any questions or concerns, feel free to reach out to us via email or phone.</p>
    <p class="text-lg text-gray-700 mt-4">Email: <a href="mailto:support@econest.com" class="text-green-700 hover:underline">support@econest.com</a></p>
    <p class="text-lg text-gray-700 mt-2">Phone: +94 11-456-789</p>
    <p class="text-lg text-gray-700 mt-2">Hours: Mon-Fri, 9 AM - 6 PM</p>
    <p class="text-lg text-gray-700 mt-4">Visit us at our office during working hours for further assistance or inquiries.</p>
  </div>
</section>
...
<main class="container mx-auto px-4 py-10">
  ...
  <div class="bg-white shadow-lg rounded-lg p-8 mt-10">
    <h2 class="text-2xl font-bold text-green-700 mb-4">Feedback Form</h2>
    
    <!-- Feedback Form with background color -->
    <form action="#" method="POST" class="space-y-4 bg-gray-200 p-6 rounded-lg">
      <div>
        <label for="name" class="block text-gray-700">Name</label>
        <input type="text" id="name" name="name" class="w-full mt-1 px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-green-500" placeholder="Your Name" required>
      </div>
      <div>
        <label for="email" class="block text-gray-700">Email</label>
        <input type="email" id="email" name="email" class="w-full mt-1 px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-green-500" placeholder="Your Email" required>
      </div>
      <div>
        <label for="message" class="block text-gray-700">Your Message</label>
        <textarea id="message" name="message" rows="5" class="w-full mt-1 px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-green-500" placeholder="Your Message" required></textarea>
      </div>
      <button type="submit" class="w-auto bg-green-600 text-white py-2 px-4 rounded-lg hover:bg-green-700 transition duration-300">SEND MESSAGE</button>
    </form>
</div>
  ...
  <div class="container mx-auto text-center grid grid-cols-1 md:grid-cols-3 gap-8">
    ...
    <div>
      <div class="flex justify-center items-center mb-0">
        <img src="logo1.png" alt="EcoNest Logo" class="h-12 mr-2">
