...
<body class="bg-gray-100">
  ...
  <div class="w-full bg-white p-8 md:p-16">
    ...
    <p class="text-lg text-gray-700 leading-relaxed mb-6">
      ...
      Our mission is to help you create a comfortable and efficient home by offering a wide range of products designed to improve your everyday living. 
