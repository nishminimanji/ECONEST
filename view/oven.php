    ...
    <div class="container mx-auto px-4 py-8">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
            ...
            <div class="bg-white shadow-lg rounded-lg overflow-hidden hover:scale-105 transition-transform">
                ...
                <div class="p-4">
                    <p class="text-lg font-semibold">Innovex Convection Electric Oven – 46L</p>
            ...
            <div class="bg-white shadow-lg rounded-lg overflow-hidden hover:scale-105 transition-transform">
                ...
                <div class="p-4">
                    <p class="text-lg font-semibold">Panasonic Grill Microwave Oven</p>
            ...
            <div class="bg-white shadow-lg rounded-lg overflow-hidden hover:scale-105 transition-transform">
                ...
                <div class="p-4">
                    <p class="text-lg font-semibold">MISTRAL 23L Electric Oven</p>
