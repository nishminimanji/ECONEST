...
<head>
  ...
  <title>EcoNest - DressingTable</title>
...
<div id="popup-message" class="fixed top-0 right-0 flex items-center justify-center z-50 bg-black bg-opacity-30 hidden">
  ...
  <body class="bg-gray-100">
    <div class="container mx-auto px-4 py-8">
        <h1 class="text-3xl font-bold text-center mb-8">Dressing Tables</h1>
        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
            ...
            <div class="bg-white shadow-lg rounded-lg overflow-hidden hover:scale-105 transition-transform">
                <div class="w-full h-45">
                    <img src="https://damro.lk/wp-content/uploads/2019/11/1C7A93754-548x450.jpg" alt="dtable 1" class="w-100 h-100 object-cover">
                </div>
                <div class="p-4">
                    <p class="text-lg font-semibold">Akira Dressing Table<p>
                    <p class="text-xl text-red-600 mt-2">Rs. 52,275</p>
            ...
            <div class="bg-white shadow-lg rounded-lg overflow-hidden hover:scale-105 transition-transform">
                <div class="w-full h-45">
                    <img src="https://damro.lk/wp-content/uploads/2024/09/dressor-1.jpg" alt="dtable 2" class="w-100 h-100 object-cover">
                </div>
                <div class="p-4">
                    <p class="text-lg font-semibold">Kalisto Dressing Table</p>
                    <p class="text-xl text-red-600 mt-2">Rs. 70,300</p>
                    <div class="mt-4 flex justify-center">
                    <button class="bg-red-500 text-white px-6 py-2 rounded-full hover:bg-red-400 add-to-cart text-center">Add to Cart</button></div>
            ...
            <div class="bg-white shadow-lg rounded-lg overflow-hidden hover:scale-105 transition-transform">
                <div class="w-full h-45">
                    <img src="https://damro.lk/wp-content/uploads/2020/02/queenston-suite-dressor-548x450.jpg" alt="dtable 3" class="w-100 h-100 object-cover">
                </div>
                <div class="p-4">
                    <p class="text-lg font-semibold">Queenston Dressing Table</p>
                    <p class="text-xl text-red-600 mt-2">Rs. 68,510</p>
                    <div class="mt-4 flex justify-center">
                    <button class="bg-red-500 text-white px-6 py-2 rounded-full hover:bg-red-400 add-to-cart text-center">Add to Cart</button></div>
             ...
             <div class="bg-white shadow-lg rounded-lg overflow-hidden hover:scale-105 transition-transform">
                <div class="w-full h-45">
                    <img src="https://damro.lk/wp-content/uploads/2020/02/nico-dresser-548x450.jpg" alt="dtable 4" class="w-100 h-100 object-cover">
                </div>
                <div class="p-4">
                    <p class="text-lg font-semibold">Nico Dressing Table </p>
                    <p class="text-xl text-red-600 mt-2">Rs. 54,275</p>
                    <div class="mt-4 flex justify-center">
                    <button class="bg-red-500 text-white px-6 py-2 rounded-full hover:bg-red-400 add-to-cart text-center">Add to Cart</button></div>
            ...
            <div class="bg-white shadow-lg rounded-lg overflow-hidden hover:scale-105 transition-transform">
                <div class="w-full h-45">
                    <img src="https://damro.lk/wp-content/uploads/2019/11/1C7A9627.jpg" alt="dtable 5" class="w-100 h-100 object-cover">
                </div>
                <div class="p-4">
                    <p class="text-lg font-semibold">Beverly Dressing Table</p>
                    <p class="text-xl text-red-600 mt-2">Rs. 231,900</p>
                    <div class="mt-4 flex justify-center">
                    <button class="bg-red-500 text-white px-6 py-2 rounded-full hover:bg-red-400 add-to-cart text-center">Add to Cart</button></div>
            ...
            <div class="bg-white shadow-lg rounded-lg overflow-hidden hover:scale-105 transition-transform">
                <div class="w-full h-45">
                    <img src="https://damro.lk/wp-content/uploads/2020/01/emerson-dressing-table-548x450.jpg" alt="dtable 6" class="w-100 h-100 object-cover">
                </div>
                <div class="p-4">
                    <p class="text-lg font-semibold">Emerson Dressing Table</p>
                    <p class="text-xl text-red-600 mt-2">Rs.165,620</p>
                    <div class="mt-4 flex justify-center">
                    <button class="bg-red-500 text-white px-6 py-2 rounded-full hover:bg-red-400 add-to-cart text-center">Add to Cart</button></div>
            ...
            <div class="bg-white shadow-lg rounded-lg overflow-hidden hover:scale-105 transition-transform">
                <div class="w-full h-45">
                    <img src="https://damro.lk/wp-content/uploads/2020/02/dressor-1-548x450.jpg" alt="dtable 7" class="w-100 h-100 object-cover">
                </div>
                <div class="p-4">
                    <p class="text-lg font-semibold">Winchester Dressing Table</p>
                    <p class="text-xl text-red-600 mt-2">Rs.77,500</p>
                    <div class="mt-4 flex justify-center">
                    <button class="bg-red-500 text-white px-6 py-2 rounded-full hover:bg-red-400 add-to-cart text-center">Add to Cart</button></div>
              ...
              <div class="bg-white shadow-lg rounded-lg overflow-hidden hover:scale-105 transition-transform">
                <div class="w-full h-45">
                    <img src="https://damro.lk/wp-content/uploads/2020/02/Yelena-M31-4-548x450.jpg" alt="dtable 8" class="w-100 h-100 object-cover">
                </div>
                <div class="p-4">
                    <p class="text-lg font-semibold">Yelena Dressing Table</p>
                    <p class="text-xl text-red-600 mt-2">Rs.45,435</p>
                    <div class="mt-4 flex justify-center">
                    <button class="bg-red-500 text-white px-6 py-2 rounded-full hover:bg-red-400 add-to-cart text-center">Add to Cart</button></div>
