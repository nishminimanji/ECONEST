...
<head>
  ...
  <style>
    /* Styling for the dropdown categories */
    .dropdown-menu {
      display: none;
...
<body class="bg-gray-100">
  ...
  <div class="flex">
    ...
    <!-- Sidebar (Categories) -->
    <aside class="bg-white p-6 rounded-lg shadow-lg w-64 space-y-6">
      <h2 class="text-xl font-bold mb-4">Categories</h2>
      
      <!-- Kitchen Appliances Dropdown -->
      <div class="dropdown relative">
        <button class="w-full text-left px-4 py-2 bg-green-100 rounded-lg flex justify-between items-center">
          Kitchen Appliances
          <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
            <path stroke-linecap="round" stroke-linejoin="round" d="M19 9l-7 7-7-7" />
          </svg>
        </button>
        <div class="dropdown-menu absolute left-0 mt-2 w-full">
          <a href="#" class="dropdown-item">Blenders</a>
          <a href="#" class="dropdown-item">Rice Cookers</a>
          <a href="#" class="dropdown-item">Ovens</a>
          <a href="#" class="dropdown-item">Gas Cookers</a>
          <a href="#" class="dropdown-item">Toasters</a>
          <a href="#" class="dropdown-item">Hot Water Kettles</a>
        </div>
      </div>
      ...
      <div class="dropdown relative">
        ...
        <div class="dropdown-menu absolute left-0 mt-2 w-full">
          ...
          <a href="#" class="dropdown-item">Hot Water Showers</a>
        </div>
      </div>

      <!-- Dining Appliances Dropdown -->
      <div class="dropdown relative">
        <button class="w-full text-left px-4 py-2 bg-green-100 rounded-lg flex justify-between items-center">
          Dining Appliances
          <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
      ...
      <div class="dropdown relative">
        ...
        <div class="dropdown-menu absolute left-0 mt-2 w-full">
          <a href="#" class="dropdown-item">TVs</a>
          <a href="#" class="dropdown-item">Sofas</a>
          <a href="#" class="dropdown-item">Suitable Tables</a>
          <a href="#" class="dropdown-item">Vacuum Cleaners</a>
        </div>
      </div>

      <!-- Outside Area Dropdown -->
      <div class="dropdown relative">
        <button class="w-full text-left px-4 py-2 bg-green-100 rounded-lg flex justify-between items-center">
          Outside Area
          <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
        ...
        <div class="dropdown-menu absolute left-0 mt-2 w-full">
          <a href="#" class="dropdown-item">Plants</a>
          <a href="#" class="dropdown-item">Chairs</a>
        </div>
      </div>
    ...
    <div class="flex-1">
      <!-- Navigation Bar -->
      <header class="bg-green-700 shadow sticky top-0 z-10">
